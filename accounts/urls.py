...
urlpatterns = [
    ...
    # Game library
    path('library', views.LibraryList.as_view(), name="my_library"),
    ...
    path('installers/', views.my_installers, name="my_installers"),
    path('submissions/', views.my_submissions, name="my_submissions"),
    path('issues/', views.my_issues, name="my_issues"),
    # Account management
